        ...
        <div className='bg-white flex flex-col   gap-6'>
            ...
            <div className="bg-gray-50  py-10 px-5">
                ...
                <div className="grid md:grid-cols-2 gap-y-10 gap-x-5 ">
                    <div className="card shadow-md min-h-[200px] p-4 bg-white rounded-lg">
                        <h1 className='font-[600]   mb-3'>Web/mobile/Desktop Developpement</h1>
                        <p className='text-gray-700'>We develop any kind of web applications using Nestjs, Laravel,JEE or .NET Core for
                    ...
                    <div className="card shadow-md min-h-[200px] p-4 bg-white rounded-lg">
                        ...
                        <p className='text-gray-700'>We design for both web and mobile android or IOS using the two best softwares Adobe XD for prototyping and Adobe Illustrator for graphic elements</p>
                    </div>
                    <div className="card shadow-md min-h-[200px] p-4 bg-white rounded-lg">
                        <h1 className='font-[600]   mb-3'>Professional Design
                        </h1>
                        <p className='text-gray-700'>Add to UI/UX design we do also professional design or commercial design includes flyers, business cards, logos or anything related to design as you like</p>
                    </div>
                    <div className="card shadow-md min-h-[200px] p-4 bg-white rounded-lg">
                        <h1 className='font-[600]   mb-3'>Data Scrapy
                        </h1>
                        <p className='text-gray-700'>We can Scrape data from any website what either he needs authentification or no, we deliver data as Json file csv or excel file format or any other format that you find good</p>
                    </div>
                </div>
            </div>
