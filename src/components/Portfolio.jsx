...
const Porfolio = ({theme}) => {
  return (
    ...
    <a href="https://spotify-clone-two-sandy.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg" >
        ...
        <a href="https://msi-app-player.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm  md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://fylo-landing-page-with-two-column-layout-ssyk.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://deliveroo-website-reactjs.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://youtube-clone-sooty-ten.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://github-finder-react-app-three.vercel.app//" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://hoobank-three-olive.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://home-market-place-gamma.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://easybank-landing-page-eight-indol.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
        ...
        <a href="https://cocktail-seven.vercel.app/" target='_blank' rel="noreferrer"><div className="hover:scale-105 ease-linear duration-200 card shadow-sm md:h-64 hover:cursor-pointer hover:shadow-lg">
